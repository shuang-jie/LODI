...
count data. The observed counts are modelled through a rounded
multivariate log-normal kernel, and the within-subject temporal signal
is decomposed into two interpretable pieces:
...
$`\Sigma_t = \Lambda \Lambda^\top + \sigma^2_t I_J`$ and cleanly
...
([`vignette("simulation1", package = "LODI")`](https://shuang-jie.github.io/LODI/articles/simulation1.md)).
